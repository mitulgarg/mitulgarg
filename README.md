...
I build and ship AI systems end-to-end, from agentic orchestration with LangGraph to production document processing and translation pipelines using vision models. I've designed Agent Registries supporting A2A, MCP, and A2T protocols for contract automation platforms, and I maintain env-doctor, an open-source CLI tool for environment validation with MCP server integration (8,000+ PyPI downloads).

In production, I've built multilingual document translation systems, async processing pipelines with queue-based architectures, MultiModel RAG Ingestion pipelines, Agent registries with webhook/callback async implementations using Langgraph Checkpointers with Redis and voice/telephony AI systems using LiveKit and Twilio SIP. I work across OCI and AWS cloud infrastructure.
